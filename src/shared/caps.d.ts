...
export const MAX_REMOTE_SLICE_ENTRIES: number;
export const MAX_REPLAY_EPOCH_CACHE_TOPICS: number;
export const MAX_RESUME_TOPICS: number;
export const MAX_STORE_PAYLOAD_BYTES: number;
export const MAX_TASK_HANDLERS: number;
export const MAX_BREAKER_LISTENERS: number;
export const MAX_BREAKER_KEYS: number;
