...
export interface CrdtClusterHandlers {
	...
	/** A peer cold-joined: if this instance holds the topic, reply with the structs it lacks. */
...
export interface CrdtCluster {
	...
	/** Answer a peer's sync request with the structs it lacks (targeted at one instance). */
